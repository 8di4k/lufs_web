...
export function LiveDemo() {
  ...
  return (
    <section id="demo" className="relative py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-black overflow-hidden">
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          <Card className="relative overflow-hidden bg-linear-to-br from-zinc-900 via-zinc-900 to-zinc-950 border border-zinc-800/50 p-4 sm:p-6 md:p-8">
            {/* Idle State */}
            <AnimatePresence mode="wait">
              {currentStage === "idle" && (
                ...
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-cyan-500/10 border-2 border-cyan-500/20">
                  ...
                  {/* Fake Drag & Drop Zone */}
                  <div className="mt-6 sm:mt-8 p-6 sm:p-8 border-2 border-dashed border-zinc-700 rounded-lg hover:border-cyan-500/50 transition-colors cursor-not-allowed opacity-50">
                    <Upload className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 sm:mb-3 text-zinc-500" />
              ...
              {currentStage !== "idle" && currentStage !== "complete" && (
                ...
                >
                    ...
                    {stages.map((stage) => {
                      ...
                      return (
                        <motion.div
                          key={stage.id}
                          className={cn(
                            "flex items-center justify-center gap-2 sm:gap-3 text-sm sm:text-base md:text-lg font-medium transition-all duration-300",
                  ...
                  <p className="text-center text-sm text-zinc-500">
                    Analyzing with 12 AI models simultaneously...
                  </p>
                </motion.div>
              )}
              ...
              {currentStage === "complete" && results && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 min-[400px]:grid-cols-3 gap-3 sm:gap-4">
                    {Object.entries(results).map(([key, value], index) => (
                      <motion.div
                        ...
                        className="p-3 sm:p-4 rounded-lg bg-zinc-800/50 border border-zinc-700/50 hover:border-cyan-500/30 transition-colors"
                      >
                        <p className="text-[10px] sm:text-xs uppercase text-zinc-500 mb-1 font-semibold">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-3 sm:pt-4">
                    ...
                    <Button
                      size="lg"
                      className="flex-1 bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold active:scale-95 transition-all"
